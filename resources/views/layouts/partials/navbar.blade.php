    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="{{ route('home.index') }}" class="btn btn-info me-2" style="margin-left: 10px;">Home</a></li>
          @auth
            @role('Admin')
        ...
        @auth
          {{auth()->user()->name}}
          <div class="text-end">
            <a href="{{ route('logout.perform') }}" class="btn btn-danger me-2" style="margin-left: 10px;">Logout</a>
          </div>
        @endauth
